...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('suppliers/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="brand_name">Supplier Phone</label>
            <input type="text" class="form-control" id="supplier_phone" name="supplier_phone" placeholder="Enter Supplier phone" autocomplete="off">
          </div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('suppliers/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="brand_name">Supplier Address</label>
            <input type="text" class="form-control" id="edit_supplier_address" name="edit_supplier_address" placeholder="Enter Supplier address" autocomplete="off">
          </div><div class="form-group">
            <label for="brand_name">Supplier Phone</label>
            <input type="text" class="form-control" id="edit_supplier_phone" name="edit_supplier_phone" placeholder="Enter Supplier phone" autocomplete="off">
          </div>
          <div class="form-group">
...
$(document).ready(function() {
  $("#mainMaintenanceNav").addClass('active');
  $("#SuppliersMenu").addClass('active');
  
  // initialize the datatable 
  manageTable = $('#manageTable').DataTable({
    'ajax': 'suppliers/fetchSuppliersData',
    'order': []
  });
...
{ 
  $.ajax({
    url: 'suppliers/fetchsuppliersDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
      ...
      $("#edit_supplier_phone").val(response.supplier_phone);
