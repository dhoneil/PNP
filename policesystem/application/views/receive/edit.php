...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Receive Orders</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Edit Receive Order</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('receive/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
						...
						<option value="<?php echo $v['id'] ?>" <?= ($v['id']==$order_data['order']['supplier_id']?"selected":"") ?>><?php echo $v['supplier_name'] ?></option>
						<?php endforeach ?>
                  </select>
					</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="supplier_address" name="supplier_address" value="<?=$order_data['order']['supplier_address']?>" disabled>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="supplier_phone" name="supplier_phone" value="<?=$order_data['order']['supplier_phone']?>" disabled>
                    </div>
                  </div>
				...
				<div class="col-md-6 col-xs-12 pull pull-left">
					<div class="form-group">
					  <label for="gross_amount" class="col-sm-3 control-label">Date:</label>
					<div class="col-sm-4">
                      <input type="date" class="form-control datepicker" id="order_date" name="order_date" value="<?php echo date('Y-m-d',$order_data['order']['date_time']) ?>" placeholder="Enter a Date" autocomplete="off">
                    </div>
					</div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'receive/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('receive/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#manageReceiveNav").addClass('active');
	...
	$("#supplier").change(function(){
		...
		if(supplier_id == "") {
		  ...
		  $.ajax({
			url: base_url + 'suppliers/getSupplierValueById',
			type: 'post',
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'receive/getProductValueById',
        type: 'post',
