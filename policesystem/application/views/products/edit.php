          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" id="generic_name" name="generic_name" placeholder="Enter generic name" value="<?php echo $product_data['generic']; ?>"  autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="sku">Lot No.</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Enter Lot No." value="<?php echo $product_data['sku']; ?>" autocomplete="off" />
                </div>
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" id="expiry" name="expiry" value="<?=set_value("expiry",$product_data['expiry'])?>" placeholder="Enter Expiry" autocomplete="off" />
                </div>
