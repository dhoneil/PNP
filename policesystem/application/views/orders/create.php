    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/create') ?>" id="frmOrder" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" disabled>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" disabled>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
					...
					<div class="col-sm-4">
                      <input type="date" class="form-control datepicker" id="order_date" name="order_date" value="<?php echo date('Y-m-d') ?>" placeholder="Enter a Date" autocomplete="off">
                    </div>
					</div>
					<div class="form-group">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" value="0.00" placeholder="Discount" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
	...
	$("#frmOrder").submit(function(){
		...
		$net_amount_value = $("#net_amount_value").val();
		$gross_amount_value = $("#gross_amount_value").val();
		
		if(isNan($net_amount_value)==true || isNan($net_amount_value)==true){
			return false;
		}else{
			return true;
		}
