...
!(function(n) {
	...
	var e = (function() {
			...
			return (
				...
				e.define('select2/utils', [ 'jquery' ], function(o) {
					...
					return (
						...
						(r.GetData = function(e, t) {
							...
							return t
								? r.__cache[n] && null != r.__cache[n][t] ? r.__cache[n][t] : o(e).data(t)
								: r.__cache[n];
						}),
					...
					return (
						...
						(i.prototype.template = function(e, t) {
							...
							null == r
								...
								: 'string' == typeof r ? (t.innerHTML = i(r)) : h(t).append(r);
						}),
						i
					);
				}),
				...
				e.define('select2/selection/single', [ 'jquery', './base', '../utils', '../keys' ], function(
					e,
					t,
					n,
					i
				...
				e.define('select2/selection/search', [ 'jquery', '../utils', '../keys' ], function(i, s, a) {
					function e(e, t, n) {
						e.call(this, t, n);
					}
					return (
					...
					return (
						...
						(n.prototype.select = function(r) {
							...
							if (((r.selected = !0), l(r.element).is('option')))
								return (r.element.selected = !0), void this.$element.trigger('change');
						...
						(n.prototype.unselect = function(r) {
							...
							if (this.$element.prop('multiple')) {
								if (((r.selected = !1), l(r.element).is('option')))
									return (r.element.selected = !1), void this.$element.trigger('change');
								this.current(function(e) {
									for (var t = [], n = 0; n < e.length; n++) {
										var i = e[n].id;
					...
					return (
						...
						(t.prototype.bind = function(e, t, n) {
							...
							e.call(this, t, n),
								...
								t.on('close', function() {
									i.$search.attr('tabindex', -1), i.$search.val(''), i.$search.trigger('blur');
								}),
								t.on('focus', function() {
				...
				e.define(
					...
					function(f, g, m, v, y, _, w, $, b, A, x, t, S, D, C, E, O, q, T, j, L, k, I, P, M, R, U, z, e) {
						function n() {
							this.reset();
						}
						return (
							(n.prototype.apply = function(t) {
								if (null == (t = f.extend(!0, {}, this.defaults, t)).dataAdapter) {
									if (
										(null != t.ajax
											? (t.dataAdapter = C)
											: null != t.data ? (t.dataAdapter = D) : (t.dataAdapter = S),
										0 < t.minimumInputLength && (t.dataAdapter = A.Decorate(t.dataAdapter, q)),
										0 < t.maximumInputLength && (t.dataAdapter = A.Decorate(t.dataAdapter, T)),
										0 < t.maximumSelectionLength && (t.dataAdapter = A.Decorate(t.dataAdapter, j)),
								...
								if (
									(null == t.resultsAdapter &&
										((t.resultsAdapter = m),
										null != t.ajax && (t.resultsAdapter = A.Decorate(t.resultsAdapter, P)),
										null != t.placeholder && (t.resultsAdapter = A.Decorate(t.resultsAdapter, I)),
										t.selectOnClose && (t.resultsAdapter = A.Decorate(t.resultsAdapter, U))),
								...
								if (null == t.selectionAdapter) {
									if (
										...
										t.allowClear && (t.selectionAdapter = A.Decorate(t.selectionAdapter, w)),
										t.multiple && (t.selectionAdapter = A.Decorate(t.selectionAdapter, $)),
								...
								this.defaults = {
									...
									matcher: function e(t, n) {
										...
										if (n.children && 0 < n.children.length) {
											for (var i = f.extend(!0, {}, n), r = n.children.length - 1; 0 <= r; r--)
				...
				'function' == typeof e.define && e.define.amd
					...
					: 'object' == typeof exports ? (module.exports = l) : l(d),
				e.define(
					'jquery.select2',
