          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
						...
						<option value="<?php echo $v['id'] ?>" <?= ($v['id']==$order_data['order']['customer_id']?"selected":"") ?>><?php echo $v['customer_name'] ?></option>
						<?php endforeach ?>
                  </select>
					</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" value="<?=$order_data['order']['customer_address']?>" disabled>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" value="<?=$order_data['order']['customer_phone']?>" disabled>
                    </div>
                  </div>
				...
				<div class="col-md-6 col-xs-12 pull pull-left">
					...
					<div class="form-group">
					  <label for="gross_amount" class="col-sm-3 control-label">Return?</label>
					<div class="col-sm-4">
                      <?php
						$options = array('No' => 'No', 'Yes' => 'Yes');
						$batch = set_value('return',$order_data['order']['return']);
						echo form_dropdown('return', $options, $batch,' class="form-control"');
					  ?>
                    </div>
					</div>
					<div class="form-group">
					  <label for="gross_amount" class="col-sm-3 control-label">Bill No.:</label>
					<div class="col-sm-4">
                      <input type="text" class="form-control" name="bill_no" value="<?php echo $order_data['order']['bill_no'] ?>" disabled>
                    </div>
					</div>
                </div>
  ...
  $(document).ready(function() {
	...
	$("#customer").change(function(){
		...
		if(customer_id == "") {
		  ...
		  $.ajax({
			url: base_url + 'customers/getCustomerValueById',
			type: 'post',
