      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Add Receive Order</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('receive/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <!--<input type="text" class="form-control" id="supplier_name" name="supplier_name" placeholder="Enter Customer Name">-->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="supplier_address" name="supplier_address" disabled>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary">Create Receive Order</button>
