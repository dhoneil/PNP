      ...
      <form role="form" action="<?php echo base_url('customers/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="brand_name">Customer Phone</label>
      ...
      <form role="form" action="<?php echo base_url('customers/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="brand_name">Customer Phone</label>
            <input type="text" class="form-control" id="edit_customer_phone" name="edit_customer_phone" placeholder="Enter customer phone" autocomplete="off">
          </div>
          <div class="form-group">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': 'customers/fetchCustomersData',
    'order': []
  });
...
{ 
  $.ajax({
    url: 'customers/fetchCustomersDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
